   ...
   <section class="center">
      ...
      <form action="search.php" method="post">
         ...
         <div class="box">
            ...
            <input id="loco" type="text" name="h_location" required maxlength="100" placeholder="enter city name" class="input">
         </div>
         <div class="flex">
            <div class="box">
               <p>property type <span>*</span></p>
               <select id="loco" name="h_type" class="input" required>
            ...
            <div class="box">
               ...
               <select id="loco" name="h_offer" class="input" required>
            ...
            <div class="box">
               ...
               <select id="loco" name="h_min" class="input" required>
...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<a href="post_property.php" style="margin-top:1.5rem, margin: left 150px;" class="btn">add new</a>';
      }
      ?>
